...
- task: AzureCLI@2
  inputs:
    ...
    inlineScript: |
      ...
      .\AzureCreateSslServerCert --FQDN "myserver.example.com" --CertificateName "MySslCert" --SignerCertificateName "MyIntermediateCA" --ExpireMonth 12 --KeyVaultUri "https://my-key-vault.vault.azure.net/" --WorkloadIdentity
```
